...
rm -fr docs && rm -fr ./target/dx/website/release/web/public && dx build --platform web --release -p website && cargo run -p website -F "generate_htmls" ./target/dx/website/release/web/public
